...
from model.tensorflow_tts.configs import (
    FastSpeechConfig,
    FastSpeech2Config,
...
from model.tensorflow_tts.models.melgan import TFMelGANGenerator
from model.tensorflow_tts.models.hifigan import TFHifiGANGenerator
from model.tensorflow_tts.models.mb_melgan import TFMBMelGANGenerator
from model.tensorflow_tts.models.parallel_wavegan import TFParallelWaveGANGenerator


from model.tensorflow_tts.inference.savable_models import (
    SavableTFFastSpeech,
    SavableTFFastSpeech2,
    SavableTFTacotron2
)
from model.tensorflow_tts.utils import CACHE_DIRECTORY, MODEL_FILE_NAME, LIBRARY_NAME
from model.tensorflow_tts import __version__ as VERSION
    ...
    def from_pretrained(cls, pretrained_path=None, config=None, **kwargs):
        ...
        if pretrained_path is not None:
            if not os.path.isfile(pretrained_path):
                ...
                if config is None:
                    from model.tensorflow_tts.inference import AutoConfig
